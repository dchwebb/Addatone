...
/* Module Version: 7.5 */
/* C:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n SamplePos_RAM -lang verilog -synth lse -bus_exp 7 -bb -arch xo3c00f -type bram -wp 10 -rp 1000 -addr_width 8 -data_width 16 -num_rows 256 -cascade -1 -memfile d:/eurorack/addatone/addatone_machx03/lut/sample_pos_lut.mem -memformat hex -writemode NORMAL  */
...
module SamplePos_RAM (Clock, ClockEn, Reset, WE, Address, Data, Q)/* synthesis NGD_DRC_MASK=1 */;
    ...
    DP8KC SamplePos_RAM_0_0_0 (.DIA8(Data[8]), .DIA7(Data[7]), .DIA6(Data[6]), 
        ...
        .DOB4(Q[13]), .DOB3(Q[12]), .DOB2(Q[11]), .DOB1(Q[10]), .DOB0(Q[9]))
             ...
             /* synthesis MEM_INIT_FILE="sample_pos_lut.mem" */;



    // exemplar begin
    // exemplar attribute SamplePos_RAM_0_0_0 MEM_LPC_FILE SamplePos_RAM.lpc
    // exemplar attribute SamplePos_RAM_0_0_0 MEM_INIT_FILE sample_pos_lut.mem
    // exemplar end
